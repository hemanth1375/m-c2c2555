        ...
        <form onSubmit={handleSubmit} className="overview-form">
            ...
            <div className="half-overview-form">
              ...
              <div className="first-last-container">
                ...
                {touched.firstName && errors.firstName && (
                  <div style = {{display:"auto", color:"red"}}>{errors.firstName}</div>
                )}
                <div>
                  <label className="overview-label-form" htmlFor="formLastName">
                    Last Name
                  </label>
                  <input
                    type="text"
                ...
                {touched.lastName && errors.lastName && (
                  <div style = {{display:"auto", color:"red"}}>{errors.lastName}</div>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="over-view-form-bottom-containers">
            ...
            <div className="right-container">
              <div>
                <label className="overview-label-form-bottom" id="formMobile">
                  MOBILE:
                </label>
                <input
                  type="text"
...
const OverViewForm: React.FC<{}> = (props: any) => {
  return(
    <div>
      <FirstForm  />
    </div>
